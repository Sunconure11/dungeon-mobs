...
public class ModelAhriman extends ModelBase
{
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, 
		...
		this.Stalk1.rotateAngleX = (MathHelper.sin((float)ent.ticksExisted * var8)
				* moo * (float)Math.PI / 180.0F) - (MathHelper.cos((float)ent.ticksExisted * var8)
						* moo * (float)Math.PI / 180.0F);
		//this.Stalk1.rotateAngleY = MathHelper.cos((float)ent.ticksExisted * var8) * moo;
		this.Stalk1.rotateAngleZ = MathHelper.sin((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F;

		this.StalkEye1.rotateAngleX = (MathHelper.sin((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F) - (MathHelper.cos((float)ent.ticksExisted * var8) 
						* moo * (float)Math.PI / 180.0F);
		//this.StalkEye1.rotateAngleY = MathHelper.cos((float)ent.ticksExisted * var8) * moo;
		this.StalkEye1.rotateAngleZ = MathHelper.sin((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F;

		this.Stalk2.rotateAngleX = (MathHelper.cos((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F) - (MathHelper.sin((float)ent.ticksExisted * var8) 
						* moo * (float)Math.PI / 180.0F);
		//this.Stalk2.rotateAngleY = MathHelper.cos((float)ent.ticksExisted * var8) * moo * (float)Math.PI / 180.0F;
		this.Stalk2.rotateAngleZ = MathHelper.cos((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F;

		this.StalkEye2.rotateAngleX = (MathHelper.cos((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F) - (MathHelper.sin((float)ent.ticksExisted * var8) 
						* moo * (float)Math.PI / 180.0F);
		//this.StalkEye2.rotateAngleY = MathHelper.cos((float)ent.ticksExisted * var8) * moo * (float)Math.PI / 180.0F;
		this.StalkEye2.rotateAngleZ = MathHelper.cos((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F;

		this.Stalk3.rotateAngleX = (MathHelper.sin((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F) - (MathHelper.cos((float)ent.ticksExisted * var8) 
						* moo * (float)Math.PI / 180.0F);
		//this.Stalk3.rotateAngleY = MathHelper.sin((float)ent.ticksExisted * var8) * moo * (float)Math.PI / 180.0F;
		this.Stalk3.rotateAngleZ = MathHelper.sin((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F;

		this.StalkEye3.rotateAngleX = (MathHelper.sin((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F) - (MathHelper.cos((float)ent.ticksExisted * var8) 
						* moo * (float)Math.PI / 180.0F);
		//this.StalkEye3.rotateAngleY = MathHelper.sin((float)ent.ticksExisted * var8) * moo * (float)Math.PI / 180.0F;
		this.StalkEye3.rotateAngleZ = MathHelper.sin((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F;

		this.Stalk4.rotateAngleX = (MathHelper.cos((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F) - (MathHelper.sin((float)ent.ticksExisted * var8) 
						* moo * (float)Math.PI / 180.0F);
		//this.Stalk4.rotateAngleY = MathHelper.sin((float)ent.ticksExisted * var8) * moo * (float)Math.PI / 180.0F;
		this.Stalk4.rotateAngleZ = MathHelper.cos((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F;

		this.StalkEye4.rotateAngleX = (MathHelper.cos((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F) - (MathHelper.sin((float)ent.ticksExisted * var8) 
						* moo * (float)Math.PI / 180.0F);
		//this.StalkEye4.rotateAngleY = MathHelper.sin((float)ent.ticksExisted * var8) * moo * (float)Math.PI / 180.0F;
		this.StalkEye4.rotateAngleZ = MathHelper.cos((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F;

		this.Stalk5.rotateAngleX = (MathHelper.sin((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F) - (MathHelper.cos((float)ent.ticksExisted * var8) 
						* moo * (float)Math.PI / 180.0F);
		//this.Stalk5.rotateAngleY = MathHelper.sin((float)ent.ticksExisted * var8) * moo * (float)Math.PI / 180.0F;
		this.Stalk5.rotateAngleZ = MathHelper.sin((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F;

		this.StalkEye5.rotateAngleX = (MathHelper.sin((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F) - (MathHelper.cos((float)ent.ticksExisted * var8) 
						* moo * (float)Math.PI / 180.0F);
		//this.StalkEye5.rotateAngleY = MathHelper.sin((float)ent.ticksExisted * var8) * moo * (float)Math.PI / 180.0F;
		this.StalkEye5.rotateAngleZ = MathHelper.sin((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F;

		this.Stalk6.rotateAngleX = (MathHelper.cos((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F) - (MathHelper.sin((float)ent.ticksExisted * var8) 
						* moo * (float)Math.PI / 180.0F);
		//this.Stalk6.rotateAngleY = MathHelper.sin((float)ent.ticksExisted * var8) * moo * (float)Math.PI / 180.0F;
		this.Stalk6.rotateAngleZ = MathHelper.cos((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F;

		this.StalkEye6.rotateAngleX = (MathHelper.cos((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F) - (MathHelper.sin((float)ent.ticksExisted * var8) 
						* moo * (float)Math.PI / 180.0F);
		//this.StalkEye6.rotateAngleY = MathHelper.sin((float)ent.ticksExisted * var8) * moo * (float)Math.PI / 180.0F;
		this.StalkEye6.rotateAngleZ = MathHelper.cos((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F;

		this.Stalk7.rotateAngleX = (MathHelper.sin((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F) - (MathHelper.cos((float)ent.ticksExisted * var8) 
						* moo * (float)Math.PI / 180.0F);
		//this.Stalk7.rotateAngleY = MathHelper.sin((float)ent.ticksExisted * var8) * moo * (float)Math.PI / 180.0F;
		this.Stalk7.rotateAngleZ = MathHelper.sin((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F;

		this.StalkEye7.rotateAngleX = (MathHelper.sin((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F) - (MathHelper.cos((float)ent.ticksExisted * var8) 
						* moo * (float)Math.PI / 180.0F);
		//this.StalkEye7.rotateAngleY = MathHelper.sin((float)ent.ticksExisted * var8) * moo * (float)Math.PI / 180.0F;
		this.StalkEye7.rotateAngleZ = MathHelper.sin((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F;

		this.Stalk8.rotateAngleX = (MathHelper.cos((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F) - (MathHelper.sin((float)ent.ticksExisted 
						* var8) * moo * (float)Math.PI / 180.0F);
		//this.Stalk8.rotateAngleY = MathHelper.sin((float)ent.ticksExisted * var8) * moo * (float)Math.PI / 180.0F;
		this.Stalk8.rotateAngleZ = MathHelper.cos((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F;

		this.StalkEye8.rotateAngleX = (MathHelper.cos((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F) - (MathHelper.sin((float)ent.ticksExisted * var8) 
						* moo * (float)Math.PI / 180.0F);
		//this.StalkEye8.rotateAngleY = MathHelper.sin((float)ent.ticksExisted * var8) * moo * (float)Math.PI / 180.0F;
		this.StalkEye8.rotateAngleZ = MathHelper.cos((float)ent.ticksExisted * var8) 
				* moo * (float)Math.PI / 180.0F;
	}
