...
public class ModelVescavor extends ModelBase {
	...
	@Override
	public void render(Entity entity, float f, float f1, float
			f2, float f3, float f4, float f5) {
	...
	public void setRotationAngles(float f, float f1,
		...
		LLegFront.rotateAngleZ = 0.3490659F - MathHelper.cos(f * 0.7662F) * 1.4F * f1;
		LLegMid.rotateAngleZ = 0.3490659F + MathHelper.cos(f * 0.7662F) * 1.4F * f1;
		LLegRear.rotateAngleZ = 0.3490659F - MathHelper.cos(f * 0.7662F) * 1.4F * f1;

		RLegFront.rotateAngleZ = -0.3490659F + MathHelper.cos(f * 0.7662F) * 1.4F * f1;
		RLegMid.rotateAngleZ = -0.3490659F - MathHelper.cos(f * 0.7662F) * 1.4F * f1;
		RLegRear.rotateAngleZ = -0.3490659F + MathHelper.cos(f * 0.7662F) * 1.4F * f1;
	}
