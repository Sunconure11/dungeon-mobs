...
public class ModelNetherHound extends ModelBase {
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity ent) {
		...
		MuzzleLow.rotateAngleX = 0.4363323F + (f4 / 57.29578F) + (MathHelper.sin((float) ent.ticksExisted * var8) * 4.5F * (float) Math.PI / 180.0F);
		MuzzleLow.rotateAngleY = f3 / 57.29578F;
		MuzzleTop.rotateAngleX = f4 / 57.29578F;
		MuzzleTop.rotateAngleY = f3 / 57.29578F;
		EarRight.rotateAngleX = f4 / 57.29578F;
		EarRight.rotateAngleY = f3 / 57.29578F;
		EarRight.rotateAngleZ = MathHelper.cos((float) ent.ticksExisted * var8) * 2.5F * (float) Math.PI / 180.0F;
		EarLeft.rotateAngleX = f4 / 57.29578F;
		EarLeft.rotateAngleY = f3 / 57.29578F;
		EarLeft.rotateAngleZ = MathHelper.cos((float) ent.ticksExisted * var8) * 2.5F * (float) Math.PI / 180.0F;
		HeadBase.rotateAngleX = f4 / 57.29578F;
		HeadBase.rotateAngleY = f3 / 57.29578F;
		
		LBLegMid.rotateAngleX = 0.9424778F + MathHelper.cos(f * 0.5662F) * 1.4F * f1 * 0.5F;
		LFPaw.rotateAngleX = MathHelper.cos(f * 0.5662F + (float) Math.PI) * 1.4F * f1 * 0.5F;
		LFLeg.rotateAngleX = MathHelper.cos(f * 0.5662F + (float) Math.PI) * 1.4F * f1 * 0.5F;
		LBPaw.rotateAngleX = MathHelper.cos(f * 0.5662F) * 1.4F * f1 * 0.5F;
		LBThigh.rotateAngleX = MathHelper.cos(f * 0.5662F) * 1.4F * f1 * 0.5F;
		LBLegLow.rotateAngleX = -0.7504916F + MathHelper.cos(f * 0.5662F) * 1.4F * f1 * 0.5F;
		LBLegTop.rotateAngleX = -0.5235988F + MathHelper.cos(f * 0.5662F) * 1.4F * f1 * 0.5F;
		
		RFLeg.rotateAngleX = MathHelper.cos(f * 0.5662F) * 1.4F * f1 * 0.5F;
		RFPaw.rotateAngleX = MathHelper.cos(f * 0.5662F) * 1.4F * f1 * 0.5F;
		RBThigh.rotateAngleX = MathHelper.cos(f * 0.5662F + (float) Math.PI) * 1.4F * f1 * 0.5F;
		RBLegTop.rotateAngleX = -0.5235988F + MathHelper.cos(f * 0.5662F + (float) Math.PI) * 1.4F * f1 * 0.5F;
		RBLegMid.rotateAngleX = 0.9424778F + MathHelper.cos(f * 0.5662F + (float) Math.PI) * 1.4F * f1 * 0.5F;
		RBLegLow.rotateAngleX = -0.7504916F + MathHelper.cos(f * 0.5662F + (float) Math.PI) * 1.4F * f1 * 0.5F;
		RBPaw.rotateAngleX = MathHelper.cos(f * 0.5662F + (float) Math.PI) * 1.4F * f1 * 0.5F;
	}
