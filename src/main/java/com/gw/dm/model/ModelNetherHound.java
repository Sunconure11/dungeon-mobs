...
public class ModelNetherHound extends ModelBase {
	...
	public void setRotationAngles(float f, float f1,
		...
		MuzzleLow.rotateAngleX = 0.4363323F + (f4 / 57.29578F)
				+ (MathHelper.sin((float) ent.ticksExisted * var8)
				* 4.5F * (float) Math.PI / 180.0F);
		...
		EarRight.rotateAngleZ = MathHelper.cos((float) ent.ticksExisted * var8)
				* 2.5F * (float) Math.PI / 180.0F;
		EarLeft.rotateAngleX = f4 / 57.29578F;
		EarLeft.rotateAngleY = f3 / 57.29578F;
		EarLeft.rotateAngleZ = MathHelper.cos((float) ent.ticksExisted * var8)
				* 2.5F * (float) Math.PI / 180.0F;
		...
		RBLegTop.rotateAngleX = -0.5235988F
				+ MathHelper.cos(f * 0.5662F + (float) Math.PI) * 1.4F * f1 * 0.5F;
		RBLegMid.rotateAngleX = 0.9424778F
				+ MathHelper.cos(f * 0.5662F + (float) Math.PI) * 1.4F * f1 * 0.5F;
		RBLegLow.rotateAngleX = -0.7504916F
				+ MathHelper.cos(f * 0.5662F + (float) Math.PI) * 1.4F * f1 * 0.5F;
