...
public class ModelUmberHulk extends ModelBase {
	...
	public void setRotationAngles(float f, float f1, float f2,
		...
		LittleEyeRight.rotateAngleX = f4 / 57.29578F;
		BigEyeRight.rotateAngleY = f3 / 57.29578F;
		BigEyeRight.rotateAngleX = f4 / 57.29578F;
		LittleEyeLeft.rotateAngleY = f3 / 57.29578F;
		...
		LeftLegLow.rotateAngleX = -0.4363323F - MathHelper.cos(f * 0.5662F + (float) Math.PI) * 1.4F * f1;
		RightLegMid.rotateAngleX = -0.1745329F - MathHelper.cos(f * 0.5662F) * 1.4F * f1;
		...
		LeftHand.rotateAngleX = -1.570796F - MathHelper.cos(f * 0.5662F) * 1.4F * f1;
		RightArmBase.rotateAngleX = -0.3490659F - MathHelper.cos(f * 0.5662F + (float) Math.PI) * 1.4F * f1;
