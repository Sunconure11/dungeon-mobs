...
public class ModelIllithid extends ModelBase {
	...
	public void setRotationAngles(float f, float f1,
		...
		HeadBack.rotateAngleX = f4 / 57.29578F;
		HeadBack.rotateAngleY = f3 / 57.29578F;
		HeadMid.rotateAngleX = f4 / 57.29578F;
		HeadMid.rotateAngleY = f3 / 57.29578F;
		MawBase.rotateAngleX = -0.5759587F + f4 / 57.29578F;
		MawBase.rotateAngleY = f3 / 57.29578F;
		TentacleBase.rotateAngleX = -0.5759587F + f4 / 57.29578F;
		TentacleBase.rotateAngleY = f3 / 57.29578F;
		EyeLeft.rotateAngleX = f4 / 57.29578F;
		EyeLeft.rotateAngleY = 0.715585F + f3 / 57.29578F;
		EyeRight.rotateAngleX = f4 / 57.29578F;
		EyeRight.rotateAngleY = -0.715585F + f3 / 57.29578F;

		float var8 = 0.01F * (float) (ent.getEntityId() % 10);

		Tentacle1.rotateAngleX = -0.3141593F + (MathHelper.sin((float) ent.ticksExisted * var8) * 4.5F * (float) Math.PI / 180.0F);// + f4 / 57.29578F;
		Tentacle1.rotateAngleY = f3 / 57.29578F;
		Tentacle1.rotateAngleZ = MathHelper.sin((float) ent.ticksExisted * var8) * 2.5F * (float) Math.PI / 180.0F;
		Tentacle2.rotateAngleX = -0.3141593F + (MathHelper.sin((float) ent.ticksExisted * var8) * 4.5F * (float) Math.PI / 180.0F);// + f4 / 57.29578F;
		Tentacle2.rotateAngleY = f3 / 57.29578F;
		Tentacle2.rotateAngleZ = MathHelper.cos((float) ent.ticksExisted * var8) * 2.5F * (float) Math.PI / 180.0F;
		Tentacle3.rotateAngleX = -0.0872665F + (MathHelper.sin((float) ent.ticksExisted * var8) * 4.5F * (float) Math.PI / 180.0F);// + f4 / 57.29578F;
		Tentacle3.rotateAngleY = f3 / 57.29578F;
		Tentacle3.rotateAngleZ = MathHelper.cos((float) ent.ticksExisted * var8) * 2.5F * (float) Math.PI / 180.0F;
		Tentacle4.rotateAngleX = -0.0872665F + (MathHelper.sin((float) ent.ticksExisted * var8) * 4.5F * (float) Math.PI / 180.0F);// + f4 / 57.29578F;
		Tentacle4.rotateAngleY = f3 / 57.29578F;
		Tentacle4.rotateAngleZ = MathHelper.sin((float) ent.ticksExisted * var8) * 2.5F * (float) Math.PI / 180.0F;

		EntityIllithid foo = (EntityIllithid) ent;

		if (!foo.isGrappling) {
			LLegB.rotateAngleX = MathHelper.cos(f * 0.5662F) * 1.4F * f1 * 0.5F;
			LLegT.rotateAngleX = MathHelper.cos(f * 0.5662F) * 1.4F * f1 * 0.5F;
			RLegB.rotateAngleX = MathHelper.cos(f * 0.5662F + (float) Math.PI) * 1.4F * f1 * 0.5F;
			RLegT.rotateAngleX = MathHelper.cos(f * 0.5662F + (float) Math.PI) * 1.4F * f1 * 0.5F;

			RArmB.rotateAngleX = MathHelper.cos(f * 0.5662F) * 1.4F * f1 * 0.5F;
			RArmT.rotateAngleX = MathHelper.cos(f * 0.5662F) * 1.4F * f1 * 0.5F;
			LArmB.rotateAngleX = MathHelper.cos(f * 0.5662F + (float) Math.PI) * 1.4F * f1 * 0.5F;
			LArmT.rotateAngleX = MathHelper.cos(f * 0.5662F + (float) Math.PI) * 1.4F * f1 * 0.5F;
		} else {
			RArmB.rotateAngleX = -0.87266F;
			RArmT.rotateAngleX = -0.87266F;
			LArmB.rotateAngleX = -0.87266F;
			LArmT.rotateAngleX = -0.87266F;
		}
	}
