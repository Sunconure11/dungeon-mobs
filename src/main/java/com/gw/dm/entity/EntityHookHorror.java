...
public class EntityHookHorror extends EntityDungeonMob {
	...
	public void onEntityUpdate() {
		if (hurtTime > 0) {
			...
			if (world.getDifficulty() == EnumDifficulty.EASY) moo = 1;
			if (world.getDifficulty() == EnumDifficulty.NORMAL) moo = 2;
			if (world.getDifficulty() == EnumDifficulty.HARD) moo = 3;
			
			if (this.rand.nextInt(5) < moo) hurtTime -= (moo * 3);
		}
