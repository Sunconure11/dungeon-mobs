...
public class EntityRustMonster extends EntityDungeonMob {
	...
	private static Set<RMFoodItem> foods = new HashSet<RMFoodItem>(((List<RMFoodItem>) Arrays.asList(new RMFoodItem[]{new RMFoodItem(Item.getItemFromBlock(Blocks.GOLD_ORE)), new RMFoodItem(Item.getItemFromBlock(Blocks.IRON_ORE)), new RMFoodItem(Item.getItemFromBlock(Blocks.RAIL)), new RMFoodItem(Item.getItemFromBlock(Blocks.GOLDEN_RAIL)), new RMFoodItem(Item.getItemFromBlock(Blocks.PISTON)), new RMFoodItem(Item.getItemFromBlock(Blocks.GOLD_BLOCK)), new RMFoodItem(Item.getItemFromBlock(Blocks.IRON_BLOCK)), new RMFoodItem(Item.getItemFromBlock(Blocks.IRON_BARS)), new RMFoodItem(Item.getItemFromBlock(Blocks.TRIPWIRE_HOOK)), new RMFoodItem(Item.getItemFromBlock(Blocks.ACTIVATOR_RAIL)), new RMFoodItem(Items.IRON_AXE), new RMFoodItem(Items.IRON_DOOR), new RMFoodItem(Items.IRON_HOE), new RMFoodItem(Items.IRON_HORSE_ARMOR), new RMFoodItem(Items.IRON_INGOT), new RMFoodItem(Items.IRON_NUGGET), new RMFoodItem(Items.IRON_PICKAXE), new RMFoodItem(Items.IRON_SHOVEL), new RMFoodItem(Items.IRON_SWORD), new RMFoodItem(Items.IRON_BOOTS), new RMFoodItem(Items.IRON_CHESTPLATE), new RMFoodItem(Items.IRON_HELMET), new RMFoodItem(Items.IRON_LEGGINGS), new RMFoodItem(Items.GOLDEN_AXE), new RMFoodItem(Items.GOLDEN_CARROT), new RMFoodItem(Items.GOLDEN_APPLE), new RMFoodItem(Items.GOLDEN_HOE), new RMFoodItem(Items.GOLDEN_HORSE_ARMOR), new RMFoodItem(Items.GOLD_INGOT), new RMFoodItem(Items.GOLD_NUGGET), new RMFoodItem(Items.GOLDEN_PICKAXE), new RMFoodItem(Items.GOLDEN_SHOVEL), new RMFoodItem(Items.GOLDEN_SWORD), new RMFoodItem(Items.GOLDEN_BOOTS), new RMFoodItem(Items.GOLDEN_CHESTPLATE), new RMFoodItem(Items.GOLDEN_HELMET), new RMFoodItem(Items.GOLDEN_LEGGINGS)})));
	...
	public static void appendToFoods(List<String> list) {
		for (String rl : list) {
			...
			Item item = Item.REGISTRY.getObject(new ResourceLocation(tokens.nextToken(), tokens.nextToken()));
	...
	protected void jump() {
		...
		if (isPotionActive(Potion.getPotionFromResourceLocation("jump_boost"))) motionY += (double) ((float) (getActivePotionEffect(Potion.getPotionFromResourceLocation("jump_boost")).getAmplifier() + 1) * 0.1F);
	...
	public boolean attackEntityFrom(DamageSource src, float amount) {
		if (src.getTrueSource() instanceof EntityPlayer) {
			...
			if ((stack != null) && (stack.getItem() != null) && foods.contains(new RMFoodItem(stack.getItem(), stack.getItemDamage()))) {
			...
			for (int i = -24; i < 24; i++)
				for (int j = -24; j < 24; j++)
					for (int k = -24; k < 24; k++) {
						...
						if (world.getBlockState(where).getBlock() == Blocks.IRON_ORE) return super.getCanSpawnHere();
						
						if (world.getBlockState(where).getBlock() == Blocks.GOLD_ORE) return super.getCanSpawnHere();
					}
			return false;
		}
