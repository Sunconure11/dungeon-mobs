...
import com.gw.dm.compat.CompatIAF;
...
public class EntityCockatrice extends EntityDungeonMob {
    ...
    public boolean attackEntityAsMob(Entity ent) {
        ...
        if (chance < stoneChance && !world.isRemote) {
            if (!Loader.isModLoaded("iceandfire")) {
                if (ent instanceof EntityPlayer && ent.ticksExisted > 100) {
                ...
                CompatIAF.turnedIntoIAFStone(this, ent, world);
            }
        }
